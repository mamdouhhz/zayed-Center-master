                  ...
                  <div class="mb-3">
                    <div class="image-preview">
                      <label for="imageInput">
                        ...
                        />
                        <div v-else class="placeholder">إضافة صورة</div>
                      </label>
                      <input
                        id="imageInput"
                        type="file"
                      ...
                      >
                        <span class="bin-icon">🗑️</span> حذف الصورة
                      </button>
                    </div>
                  </div>
                </div>
...
function populateTable() {
  ...
  sessions.value.forEach((session) => {
    ...
    console.log("🚀 ~ sessions.value.forEach ~ fromIndex:", fromIndex);
    const toIndex = timeToIndex(session.to);
    console.log("🚀 ~ sessions.value.forEach ~ toIndex:", toIndex);
